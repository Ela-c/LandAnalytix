...
import { MapToolbar } from "./components/map-tool-bar";
						...
						onUndo={() => {
							if (drawRef.current) {
								...
								if (features.length > 0) {
									...
									// drawRef.current.delete(lastId);
									console.debug(
										"Undo requested for feature ID:",
										lastId,
									);
								}
							}
						}}
						setUploadedParcels={setUploadedParcels}
